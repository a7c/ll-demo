...
const translationSchema = {
  ...
  required: ["original", "naturalTranslation", "directTranslation", "chunkPairs"]
};
...
Return your response as a JSON object matching the provided schema.`
    ...
    schema: {
      ...
      properties: {
        ...
        chunkPairs: { type: "array", items: { type: "object", properties: { original: { type: "string" }, translation: { type: "string" } }, required: ["original", "translation"] } } },
      },
      required: ["original", "naturalTranslation", "directTranslation", "chunkPairs"],
    ...
    const translationData = response.content[0].text as TranslationResponse;
